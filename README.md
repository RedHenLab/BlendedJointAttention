...
<ol>
<li> Face detection : Detection of number of human faces, possible extensions to their position and orientation
<li> Emotion recognition : Recognising different emotions (sad, happy, surprised, neutral etc.) using a CNN classifier
<li> Gaze direction recognition : Calculating angle of ones gaze using initial pupil detection and terminal points of eyes.
<li> Age detection : Categorising a person's age via facial features (outputs a range of possible age values)
<li> Facial Landmark detection : Detecting major facial landmarks, which is useful for Gaze direction and Emotion recognition. 
